<template>
  <div class="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-gray-900 to-gray-800 text-white px-4">
    <!-- Título -->
    ...
    <div class="grid md:grid-cols-2 gap-14">
      ...
      <div class="bg-gray-800/50 border w-80 border-gray-700 rounded-2xl p-6">
        <p class="text-lg font-semibold mb-4">Next player: X</p>
        ...
        <div class="grid grid-cols-3 gap-2">
          ...
          >
            <!-- conteúdo do quadrado (X ou O futuramente) -->
          </button>
        </div>
      </div>
      ...
      <div class="bg-gray-800/50 border w-80 border-gray-700 rounded-2xl p-6 w-full max-w-sm">
        ...
        <div>
          ...
          <button
            class="w-full bg-gray-700 hover:bg-gray-600 text-sm py-2 rounded-xl transition"
          >
            Go to game start
          </button>
        </div>
